...
function loadExperiment() {
    ...
    if (!Detector.webgl) {
        ...
        PIEtoplineElem.style.color = "#ffffff";
        ...
        PIEsourceElem.innerHTML = '<a href="http://www.ekshiksha.org.in" style="color:#fff;" target="_blank"><b><u>ekshiksha</u></b></a>';
...
function PIEaddSystemButtons() {
    ...
    PIEresetButton.innerHTML = '<img src="./images/ButtonRound.png" alt="reset" style="height: inherit; width: 60%;">';
    ...
    PIEpauseButton.innerHTML = '<img src="./images/ButtonPause.png" alt="pause" style="height: inherit; width: 60%;">';
    ...
    PIEresumeButton.innerHTML = '<img src="./images/ButtonPlay.png" alt="resume" style="height: inherit; width: 60%;">';
    ...
    PIEinfoButton.innerHTML = '<img src="./images/ButtonInfo.png" alt="info" style="height: inherit; width: 60%;">';
    ...
    PIEhelpButton.innerHTML = '<img src="./images/ButtonHelp.png" alt="help" style="height: inherit; width: 60%;">';
...
function PIEsetCellInput(e, a, b, d) {
    ...
    PIEtableData[PIEcurrentTable][e][a].appendChild(PIEcreateInputElement(b, d))
}
